...
export const uiSchema: ICardSchemaMeta<IBaseCardSchema> = {
  rows: [
      ...
      fields: [
        {
          ...
          dateRangeValidations: {
            startDate: {
              minDaysFromToday: 0 // Can't pick past dates
            },
            endDate: {
              minDaysFromToday: 1 // Must be at least 1 day after start date
            }
          }
        }
      ]
    ...
    {
      title: 'טווח תאריכים עם ולידציות מתקדמות',
      collapsible: true,
      fields: [
        {
          path: 'workSchedule',
          label: 'לוח עבודה (ימים א-ה בלבד)',
          component: FieldComponentType.inputDateRange,
          startDateLabel: 'תחילת עבודה',
          endDateLabel: 'סיום עבודה',
          startDatePlaceholder: 'בחר תחילת עבודה',
          endDatePlaceholder: 'בחר סיום עבודה',
          startDatePath: 'workSchedule.startDate',
          endDatePath: 'workSchedule.endDate',
          dateRangeValidations: {
            startDate: {
              minDaysFromToday: 1, // Must be from tomorrow
              allowedDaysOfWeek: [0, 1, 2, 3, 4] // Sunday to Thursday only
            },
            endDate: {
              minDaysFromToday: 0, // Can start from start date
              allowedDaysOfWeek: [0, 1, 2, 3, 4] // Sunday to Thursday only
            }
          }
        },
        {
          path: 'eventDates',
          label: 'תאריכי אירוע (סוף שבוע בלבד)',
          component: FieldComponentType.inputDateRange,
          startDateLabel: 'תחילת אירוע',
          endDateLabel: 'סיום אירוע',
          startDatePlaceholder: 'בחר תחילת אירוע',
          endDatePlaceholder: 'בחר סיום אירוע',
          startDatePath: 'eventDates.startDate',
          endDatePath: 'eventDates.endDate',
          dateRangeValidations: {
            startDate: {
              minDaysFromToday: 7, // Must be at least 7 days from today
              allowedDaysOfWeek: [5, 6] // Friday and Saturday only
            },
            endDate: {
              minDaysFromToday: 0, // Can start from start date
              allowedDaysOfWeek: [5, 6] // Friday and Saturday only
